<?php
include "../../util/helpers/user_translator.php";
include  "../../util/helpers/additional_functions.php";
$translator = new user_translator();
$handler = new additional_functions();
?>
...
<div id="sidebar">
    ...
    <div id="user">
        <div id="user_info">
            ...
            <p id="role"><?php echo $lang['sidebar']['role']?>&nbsp;<span id="role_color"><?php $translator->translate_role($_SESSION['role']);?></span></p>
            <p id="area"><?php echo $lang['sidebar']['area']?>&nbsp;<?php $translator->translate_area($_SESSION['area']);?></p>
