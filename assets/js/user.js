$(document).ready(function ()
{
    ...
    $.each(areas, function (ind, val) { if(current === val) $.each(departments[ind], function (index, value) { $('#department').append(value); }); });
    $.each(areas, function (ind, val) { if(current === val) $.each(jobs[ind], function (index, value) { $('#job').append(value); }); });
});